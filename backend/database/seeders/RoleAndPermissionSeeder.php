...
class RoleAndPermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roleDefs = [
            ...
            'Admin'          => ['ver-usuarios','crear-usuarios','ver-clientes','crear-clientes','ver-productos','crear-productos','editar-precios','ver-ventas','crear-ventas','anular-ventas','nota-credito','ver-stock','ajustar-stock','kardex','ver-compras','crear-compras','aprobar-compras','ver-finanzas','enviar-sunat','ver-rutas','ver-dashboard','ver-reportes'],
            ...
            'Vendedor'       => ['ver-clientes','crear-clientes','ver-productos','ver-ventas','crear-ventas','ver-stock','ver-dashboard'],
