...
class RoleAndPermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissionDefs = [
            ...
            ['name' => 'ver-clases',       'descripcion' => 'Ver listado de clases de productos',     'modulo' => 'Products'],
            ['name' => 'crear-clases',     'descripcion' => 'Crear nuevas clases de productos',       'modulo' => 'Products'],
            ['name' => 'editar-clases',    'descripcion' => 'Editar clases de productos existentes',  'modulo' => 'Products'],
            ['name' => 'eliminar-clases',  'descripcion' => 'Eliminar clases de productos (cascada a subclases)', 'modulo' => 'Products'],
            ['name' => 'ver-subclases',    'descripcion' => 'Ver listado de subclases de productos',  'modulo' => 'Products'],
            ['name' => 'crear-subclases',  'descripcion' => 'Crear nuevas subclases de productos',    'modulo' => 'Products'],
            ['name' => 'editar-subclases', 'descripcion' => 'Editar subclases de productos existentes', 'modulo' => 'Products'],
            ['name' => 'eliminar-subclases', 'descripcion' => 'Eliminar subclases de productos',       'modulo' => 'Products'],
            ...
            ['name' => 'generar-reportes-productos', 'descripcion' => 'Generar reportes de productos', 'modulo' => 'Products'],
        ...
        $roleDefs = [
            ...
            'Admin' => ['ver-usuarios', 'crear-usuarios', 'ver-personal', 'crear-personal', 'editar-personal', 'eliminar-personal', 'generar-reportes-personal', 'generar-reportes-productos', 'ver-clientes', 'crear-clientes', 'editar-clientes', 'eliminar-clientes', 'ver-productos', 'crear-productos', 'editar-productos', 'eliminar-productos', 'editar-precios', 'ver-clases', 'crear-clases', 'editar-clases', 'eliminar-clases', 'ver-subclases', 'crear-subclases', 'editar-subclases', 'eliminar-subclases', 'ver-ventas', 'crear-ventas', 'editar-ventas', 'confirmar-ventas', 'anular-ventas', 'eliminar-ventas', 'nota-credito', 'ver-stock', 'ajustar-stock', 'kardex', 'ver-compras', 'crear-compras', 'editar-compras', 'confirmar-compras', 'anular-compras', 'eliminar-compras', 'ver-proveedores', 'crear-proveedores', 'editar-proveedores', 'eliminar-proveedores', 'aprobar-compras', 'ver-finanzas', 'enviar-sunat', 'ver-rutas', 'ver-dashboard', 'ver-reportes', 'ver-configuracion', 'configurar-empresa'],
            'Gerente' => ['ver-usuarios', 'ver-personal', 'generar-reportes-personal', 'generar-reportes-productos', 'ver-clientes', 'ver-productos', 'ver-clases', 'ver-subclases', 'ver-ventas', 'confirmar-ventas', 'ver-stock', 'kardex', 'ver-compras', 'confirmar-compras', 'ver-proveedores', 'ver-finanzas', 'ver-dashboard', 'ver-reportes'],
            'Vendedor' => ['ver-clientes', 'crear-clientes', 'ver-productos', 'ver-clases', 'ver-subclases', 'ver-ventas', 'crear-ventas', 'editar-ventas', 'confirmar-ventas', 'nota-credito', 'ver-stock', 'ver-dashboard'],
            'Jefe-Almacen' => ['ver-productos', 'ver-clases', 'ver-subclases', 'ver-stock', 'ajustar-stock', 'kardex', 'ver-compras', 'confirmar-compras', 'ver-proveedores', 'ver-dashboard'],
            'Almacenero' => ['ver-productos', 'ver-clases', 'ver-subclases', 'ver-stock', 'ajustar-stock'],
            ...
            'Comprador' => ['ver-productos', 'ver-clases', 'crear-clases', 'editar-clases', 'eliminar-clases', 'ver-subclases', 'crear-subclases', 'editar-subclases', 'eliminar-subclases', 'ver-compras', 'crear-compras', 'editar-compras', 'confirmar-compras', 'anular-compras', 'eliminar-compras', 'ver-proveedores', 'crear-proveedores', 'editar-proveedores', 'eliminar-proveedores', 'ver-dashboard'],
