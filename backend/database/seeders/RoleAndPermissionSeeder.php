...
class RoleAndPermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roleDefs = [
            ...
            'Gerente'        => ['ver-usuarios','ver-personal','generar-reportes-personal','ver-clientes','ver-productos','ver-clases','ver-subclases','ver-ventas','confirmar-ventas','ver-stock','kardex','ver-compras','confirmar-compras','ver-proveedores','ver-finanzas','ver-dashboard','ver-reportes'],
